# I had to remove the "-8" from llvm-config commands. This is a reminder to myself, and anyone who checks this, you may have to re add it to the make file and the llvm-run file.
